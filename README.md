...
| FZ-02 | Inicijalno postavljanje master lozinke | Prilikom procesa registracije korisnik definira master lozinku iz koje se izvodi ključ za enkripciju svih budućih podataka. |
| FZ-03 | Dodavanje korisničkog računa | Korisnik može dodati novi zapis (račun) unosom naziva servisa, korisničkog imena/e-maila i lozinke. |
| FZ-04 | Prikaz računa u obliku kartica | Svi spremljeni računi prikazuju se na početnom zaslonu u obliku kartice s nazivom servisa i osnovnim podacima. |
| FZ-05 | Uređivanje postojećeg računa | Korisnik može izmijeniti podatke (naziv, korisničko ime, lozinku) već spremljenog računa. |
| FZ-06 | Brisanje korisničkog računa | Korisnik može trajno ukloniti odabrani zapis iz baze podataka. |
| FZ-07 | Generiranje nasumične lozinke | Aplikacija generira nasumičnu lozinku prema odabranim parametrima (dužina, velika/mala slova, brojevi, posebni znakovi). |
| FZ-08 | Kategorizacija računa | Korisnik može dodijeliti kategoriju/oznaku svakom računu radi lakšeg filtriranja i pregleda. |
| FZ-09 | Pretraživanje i filtriranje računa | Korisnik može pretraživati spremljene račune po nazivu servisa ili filtrira prikaz po kategoriji. |
| FZ-10 | Kopiranje podataka u međuspremnik | Korisnik može jednim klikom kopirati korisničko ime ili lozinku u međuspremnik radi jednostavnog korištenja u drugim aplikacijama. |
| FZ-11 | Automatsko popunjavanje obrazaca | Na zahtjev korisnika, aplikacija putem simulacije unosa tipkovnice popunjava prijavna polja (korisničko ime i lozinka) u trenutno aktivnom prozoru drugog programa. |
| FZ-12 | Sigurnosna kopija loklane baze podataka | Na korisnikov zahtjev moći će se kreirati kopija baze podataka. |
