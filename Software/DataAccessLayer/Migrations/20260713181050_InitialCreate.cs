    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AccountCategory", x => new { x.AccountsAccountId, x.CategoriesCategoryId });
                    table.ForeignKey(
                        name: "FK_AccountCategory_Accounts_AccountsAccountId",
                        column: x => x.AccountsAccountId,
                        principalTable: "Accounts",
                        principalColumn: "AccountId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AccountCategory_Categories_CategoriesCategoryId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AccountCategory_CategoriesCategoryId",
